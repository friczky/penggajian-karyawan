                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
							...
							</button> <a href="<?= base_url()?>admin/laporan/cetak_semua" class="btn btn-success"><i class="fa fa-print"></i> Cetak Semua Gaji</a>
							</div>
						</div>
						<br>
				...
				<div class="modal-dialog modal-lg modal-center">
					...
					<div class="modal-body">
						...
						<table class="table table-responsive">
							...
							<tr>
								<td>Rp. <?php $angka=number_format($gaji['gaji_pokok']); $uang = str_replace(',', '.', $angka); echo $uang?> ;-</td>
								<td>Rp. <?php $angka=number_format($gaji['tunjangan_jabatan']); $uang = str_replace(',', '.', $angka); echo $uang?> ;-</td>
								<td>Rp. <?php $angka=number_format($potongan); $uang = str_replace(',', '.', $angka); echo $uang?> ;-</td>
